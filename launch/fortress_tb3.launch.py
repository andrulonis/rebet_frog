...
def generate_launch_description():
    ...
    set_env_vars_resources_tb = AppendEnvironmentVariable(
            'GZ_SIM_RESOURCE_PATH',
            os.path.join(get_package_share_directory('turtlebot3_gazebo'),
                         'models'))
    
    set_env_vars_resources_frog = AppendEnvironmentVariable(
            'GZ_SIM_RESOURCE_PATH',
            os.path.join(get_package_share_directory('rebet_frog'),
                         'models'))
    ...
    ld.add_action(set_env_vars_resources_tb)
    ld.add_action(set_env_vars_resources_frog)
